...
$file = "http://feed43.com/5315716052181715.xml";   // normalmente el xml en wordpress esta en tu dominio.com/feed/
...
//$enlace = utf8_decode($enlace);

$code = $tmhOAuth->request('POST', 'https://api.twitter.com/1.1/statuses/update_with_media.json',
array(
    'media[]'  => file_get_contents($foto[0]),
