...
$file = "http://pipes.yahoo.com/pipes/pipe.run?_id=aee4d9cb628330a68debc566b4aa6b73&_render=rss";   // normalmente el xml en wordpress esta en tu dominio.com/feed/
...
array(
    'media[]'  => file_get_contents($item->link),
