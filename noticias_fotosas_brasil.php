...
$response = array();
$archivo=fopen("C:\\robots\\CD_Root\\AutoPlay\\Docs\\servidor\\htdocs\\Toucheggs\\datos.txt","w+") or die("Problemas");
...
// --------------------------------------- //
	...
	$file = "http://fotosas.freehostia.com/?category_name=brasil&feed=rss2";   // normalmente el xml en wordpress esta en tu dominio.com/feed/
...
$texto = utf8_decode($noticia[$random_number]);
fputs($archivo, $texto);
fclose($archivo);
